...
CREATE ROLE poweta;
ALTER ROLE poweta WITH SUPERUSER INHERIT CREATEROLE CREATEDB LOGIN NOREPLICATION NOBYPASSRLS PASSWORD 'md5e6cfd34eb47cc9c85ea9b2ed65743662';
...
1	acas	nidheeshchandran551@gmail.com	ac	Application And Web Development	aca	2023-08-05 20:31:43.649231+05:30
\.
...
135	\N	45	38	\N	\N	0	0	2023-08-31 14:56:02.150051+05:30	2023-08-31 14:56:02.150051+05:30	pending	\N	0
...
1161	/SELECT -BLU- FROM users WHERE email=§lib@gmail-BLUBLUBLU-com§ AND password=§1234§	2023-08-31 09:29:21+05:30
...
1049	/SELECT -BLU- FROM users WHERE email=§jishnu@gmail-BLUBLUBLU-com§ AND password=§1234§	2023-08-31 09:24:12+05:30
...
1051	/SELECT cart-BLUBLUBLU-id, books-BLUBLUBLU-title, books-BLUBLUBLU-descrption,cart-BLUBLUBLU-status, books-BLUBLUBLU-image_path FROM cart  LEFT JOIN books ON cart-BLUBLUBLU-book_fkey = books-BLUBLUBLU-id WHERE cart-BLUBLUBLU-user_fkey=45;  	2023-08-31 09:26:58+05:30
...
1029	/SELECT -BLU- FROM BOOKS  WHERE is_deleted=§0§ ORDER BY books-BLUBLUBLU-id;	2023-08-31 09:28:38+05:30
...
SELECT pg_catalog.setval('public.cart_id_seq', 135, true);
...
SELECT pg_catalog.setval('public.update_id_seq', 1777, true);
...
1	31	medi	8967\n	4f68604c-79bc-4946-9eba-6afb23bdf4bc	2023-07-24 16:43:52.978345+05:30	2023-07-24 16:43:52.978345+05:30
2	313	library	8955\n	27395bef-6051-4ea0-968f-0f18b98fec72	2023-07-24 18:22:29.642505+05:30	2023-07-24 18:22:29.642505+05:30
3	13	beta	22337	b44a16b0-e6ee-4c3c-b44a-c832109247e7	2023-07-24 18:24:40.319084+05:30	2023-07-24 18:24:40.319084+05:30
\.
